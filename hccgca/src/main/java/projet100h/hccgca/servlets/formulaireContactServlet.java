...
@WebServlet("/formulaire_contact")
public class formulaireContactServlet extends AbstractGenericServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<Contact> listContacts = ContactService.getInstance().listContact();
		context.setVariable("contacts", listContacts);
